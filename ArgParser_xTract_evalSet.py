...
def collect_args():
    ...
    at the end.
    """
    parser = argparse.ArgumentParser(description='Generate a set of ' + \
        'sequences by comparing two UniProt-SwissProt files at two ' + \
        'time points.')
    parser.add_argument('-I1', '--input1', required=True, help=' Specifies ' + \
        'path to a UniProt-SwissProt file at time t1.')
    parser.add_argument('-I2', '--input2', required=True, help=' Specifies ' + \
        'path to a UniProt-SwissProt file at time t2 (>t1).')
