...
* Download time for the UniProtKB/SwissProt files: 01 hr, 14 min, and 30 sec.
* Gene count time for query species in the target set of UniProtKB/SwissProt files: 
