...
#git rm  ../misc/gitDelFiles.sh 
#git commit -m 'Delete the script from git repo' ../misc/gitDelFiles.sh
...
git add ../misc/gitPush_PRcurves.sh 
git commit -m 'Script for computing precision-recall' ../misc/gitPush_PRcurves.sh
